...
export const useTalentCategories = (talentCategories) => {
    ...
    // 가나다순 정렬
    const sortedTalentCategories = [...talentCategories]?.sort((a, b) => a.name.localeCompare(b.name));
...
export const useRegionCategories = (regionCategories) => {
    ...
    // 가나다 순 정렬
    const sortedRegionCategories = [...regionCategories]?.sort((a, b) => a.name.localeCompare(b.name));
