...
import {fetchTalentCategoryData} from "../../store/slices/talentCategorySlice.js";
import {useCallback, useEffect} from "react";

const useInitializeTalentCategoryRedux= () => {
...
//  -> 이 hook은, createAsyncThunk로 정의된 함수를 호출하는 훅입니다.
    ...
    const loadTalentCategoryData = useCallback(async () => {
        if (!initialized) {
            await dispatch(fetchTalentCategoryData());
        }
    ...
    return loadTalentCategoryData;
};

export default useInitializeTalentCategoryRedux;